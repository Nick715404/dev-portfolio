		...
		<main className='mt-20 lg:mt-32 sm:mt-28'>
				...
				<div className='mb-20 lg:mb-8'>
					<MotionBox>
						<h1 className='text-[4.8rem] font-medium leading-tight mb-8 xl:text-[4rem] lg:text-[1.8rem] lg:leading-snug lg:mb-4'>
							...
							with <b>React</b> and <b>Next. </b>
							<br className='lg:hidden' />
							Based in Chelyabinsk, Russia.
						</h1>
					</MotionBox>
					<MotionBox delay={0.3}>
						<span>◎︎ Last updated — September 2024</span>
					</MotionBox>
				</div>
			...
			<About>
				<div className='w-[50%] flex flex-col justify-between gap-5 h-full lg:w-full'>
					<MotionBox delay={0.2}>
						<h2 className='text-6xl font-medium mb-16 md:text-4xl md:mb-6'>
							About me
						</h2>
						<p className='text-medium text-2xl mb-8 md:mb-4 md:text-lg sm:text-base'>
							I am a front-end developer with more than a year of experience in
							commercial development in a web studio. I develop applications and
							websites using React, Next and WordPress.
						</p>
						<p className='text-medium text-2xl mb-8 md:mb-4 md:text-lg sm:text-base'>
							I have experience supervising a team of junior developers. Guided
							the guys in implementing the architecture and functionality of the
							application.
						</p>
					...
					<MotionBox delay={0.25}>
						<a
							href='#'
							download={'/resume.pdf'}
							className='flex items-center justify-center gap-4 border border-white text-lg px-14 py-4 rounded-xl font-medium transition outline-none w-fit hover:bg-white hover:text-black md:w-full md:mb-4'
						>
